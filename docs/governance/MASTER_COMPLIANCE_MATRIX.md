...
| MC-005 | CI/CD | Coverage gate real no CI | Antes houve superdeclaracao de enforcement | Thresholds coerentes no root/pacotes e falha real no CI | PARCIAL | Thresholds root ainda conservadores; shared agora tem thresholds por pacote | Rodar testes com coverage no CI | Nao | Rodada 11 | Thresholds root 25%/15% conservadores; shared agora tem 80%/50% por pacote |
