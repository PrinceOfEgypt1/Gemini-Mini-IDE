...
| MC-009 | Arquitetura | Preservar salvaguardas gerais sem reintroduzir Prompt 7 | Remocoes anteriores foram parcialmente corretas | Validadores e auditorias genericas integrados ao runtime | PARCIAL | Fechar integracao e testes | Execucao do fluxo real | Nao | Rodada 3 | Validar manifesto -> geracao -> validacao |
| MC-010 | Runtime | Integracao efetiva de `BaseProjectAuditor` e afins | Antes existiam componentes nao plenamente integrados | Chamadas reais no fluxo principal + testes | PARCIAL | Revisar integracao completa | Testes e leitura do fluxo real | Nao | Rodada 3 | Confirmar nao ornamental |
...
| MC-015 | Documentacao | README fiel ao estado real | Melhorou, mas ainda pode divergir | README sem superdeclaracao | PARCIAL | Revisar apos cada rodada | Conferencia manual contra codigo | Nao | Rodada 3 | Verificar alinhamento pos-correcoes |
