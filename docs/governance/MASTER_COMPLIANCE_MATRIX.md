...
| MC-017 | UI/UX | UI premium integrada ao app principal | Antes componentes premium nao estavam integrados | Fluxo principal usando componentes finais | PARCIAL | Implementar hooks faltantes ou remover AppRefactored.tsx | Build + uso real em `main.tsx/App.tsx` | Nao | Rodada 7 | App.tsx funcional; AppRefactored.tsx tem hooks faltantes (useProjectState, useChatState, useUIState, useProjectActions) |
