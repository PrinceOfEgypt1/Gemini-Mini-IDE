...
echo "🧠 [Fix] Refinando a lógica do Parser de Descoberta (Regex)..."

UI_DIR="packages/ui/src"

# ==============================================================================
# 1. Atualizar discoveryParser.ts
# Melhoria: Inclusão de mais palavras-chave no loop de extração
# ==============================================================================
echo "📝 Atualizando $UI_DIR/utils/discoveryParser.ts..."
...
echo "✅ Lógica do Parser refinada. Agora entende 'tem que', 'precisa', etc."
