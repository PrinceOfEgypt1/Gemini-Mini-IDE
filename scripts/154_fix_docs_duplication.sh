...
echo "📚 [Docs] Corrigindo duplicidade da Fase 12 no DEVELOPMENT.md..."

DEV_DOC="DEVELOPMENT.md"

# Reescreve o arquivo com a estrutura limpa e correta
cat > "$DEV_DOC" <<EOF
...
echo "✅ DEVELOPMENT.md corrigido: Fase 12 movida para histórico e removida do roadmap."
