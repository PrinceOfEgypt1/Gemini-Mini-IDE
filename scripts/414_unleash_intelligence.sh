...
# ------------------------------------------------------------------------------
# Script: scripts/414_unleash_intelligence.sh
# Objetivo: Remover restrições das Personas e habilitar geração complexa (HU 16.1)
# Autor: Mini-IDE Agent
# Data: 2025-11-24
# ------------------------------------------------------------------------------

echo "🔓 Desbloqueando capacidade cognitiva total das Personas..."

# 1. RECONFIGURAR PERSONA PRODUCT (Analista Sênior)
# ------------------------------------------------------------------------------
...
export class ProductPersona extends BasePersona {
  protected getRoleDescription(): string {
    return \`
Você é um Arquiteto de Soluções e Product Owner Sênior.
...
echo "✅ Persona Product atualizada para nível Sênior."

# 2. RECONFIGURAR PERSONA ENGINE (Tech Lead)
# ------------------------------------------------------------------------------
...
echo "✅ Persona Engine atualizada para gerar Scaffolding completo."
EOF
