...
log_info "Corrigindo variável não utilizada em TokenMeter.tsx..."

# Reescreve o componente utilizando a variável statusText
...
EOF
log_ok "TokenMeter corrigido (statusText utilizado)."
