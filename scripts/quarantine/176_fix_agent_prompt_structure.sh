...
echo "🧠 [Fix] Refinando Prompt do Agente para garantir estrutura JSON correta..."

AGENT_FILE="packages/analysis-agent/src/agent.ts"

# ==============================================================================
# 1. Reescrever agent.ts com Prompt Reforçado
# Adicionamos um exemplo JSON explícito no System Prompt
# ==============================================================================
echo "📝 Atualizando $AGENT_FILE..."
...
# 2. Validação
# ==============================================================================
echo "🏗️  Reconstruindo Agente..."
pnpm --filter @mini-ide/analysis-agent build

echo "✅ Prompt reforçado com 'One-Shot Example' e Schema estrito."
echo "⚠️  Reinicie o servidor para aplicar a mudança!"
