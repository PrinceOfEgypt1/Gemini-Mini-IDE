...
echo "📚 [Audit] Corrigindo local das Especificações Técnicas (Backlog -> Development)..."

# ==============================================================================
# 1. Limpar BACKLOG.md (Remover Detalhamento Técnico)
# ==============================================================================
BACKLOG="docs/BACKLOG.md"
echo "📝 Restaurando padrão do $BACKLOG..."
...
# ==============================================================================
# 2. Enriquecer DEVELOPMENT.md (Inserir Detalhamento Técnico)
# ==============================================================================
DEV_DOC="DEVELOPMENT.md"
echo "📝 Movendo especificações técnicas para $DEV_DOC..."
...
echo "✅ Documentos corrigidos: Specs movidas para DEVELOPMENT.md, BACKLOG.md limpo."
