...
# ------------------------------------------------------------------------------
# Script: scripts/412_enable_smart_extraction.sh
# Objetivo: Remover restrições "burras" e habilitar extração semântica rica da Persona Product
# Autor: Mini-IDE Agent
# Data: 2025-11-24
# ------------------------------------------------------------------------------

echo "🧠 Habilitando Inteligência Semântica na Persona Product..."
...
echo "✅ Persona Product atualizada: Agora ela lê, entende e extrai, em vez de ignorar."
EOF
